...
function AddBooktoCart() {
  ...
  useEffect(() => {
    axios
      .post(`http://localhost:5000/bookinfo`, { book_id })
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/genrenamefromgenreid/${genre_id}`)
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/languagenamefromlanguageid/${langId}`)
      .then((res) => {
  ...
  function addToCart(e) {
    axios
      .post(`http://localhost:5000/bookinfo/quantity`, { book_id })
      .then((res) => {
    ...
    axios
      .post(`http://localhost:5000/addToCart`, { book_id, order_id, quantity })
      .then((res) => {
        console.log(res.data);
      })
      .catch((err) => console.log(err));
        ...
        <Col className="col-sm mt-3">
          ...
          <Container className="quantity">
            ...
            <Row>
              ...
              <Col className="btnss">
                <button type="button" onClick={increment} class="btn btn-dark">
                  +
                </button>
                <button
                  type="button"
